...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for x in range(shift):
            shift_dict.update({alphabet_lower[x] : alphabet_capital[x]})
        return shift_dict
    ...
    def apply_shift(self, shift):
        ...
        for char in self.message:
            if char.isalpha():
                shifted_char = shifted_dict[char]
            else:
                shifted_char = char
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for shift in range(26):
            ...
            valid_words = sum([1 for word in words if is_word(self.valid_words, word)])
